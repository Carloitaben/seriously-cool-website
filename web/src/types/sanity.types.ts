...
export type MediaOrProjectBlockMediaOrProjectBlockRichText =
  | Media
  | ProjectBlockMedia
...
export type GetSettingsQuery = {
  ...
  allSettings: Array<{
    ...
    slidingTextsError: Array<string>
    ...
    colors: Array<{
      __typename?: "SettingsThemeColor"
      background: { __typename?: "Color"; hex: string }
      text: { __typename?: "Color"; hex: string }
      card: { __typename?: "Color"; hex: string }
    }>
  }>
}
  ...
  allProject: Array<{
    ...
    thumbnail: {
      ...
      video: {
        ...
        mp4: {
          __typename?: "File"
          asset: { __typename?: "SanityFileAsset"; url: string }
        }
      }
      image: {
        __typename?: "MediaImage"
...
export type GetProjectQuery = {
  ...
  allProject: Array<{
    ...
    blocks: Array<
      ...
      | { __typename: "ProjectBlockRichText"; _key: string; textRaw: any }
    >
    roles: Array<{
      __typename?: "ProjectRole"
      _key: string
...
export type GetAboutQuery = {
  ...
  allAbout: Array<{
    ...
    firstParagraph: Array<{
      ...
      firstArtistHref: string
      secondArtistName: string
      secondArtistHref: string
    }>
    paragraphs: Array<{
      __typename?: "AboutParagraph"
      _key: string
